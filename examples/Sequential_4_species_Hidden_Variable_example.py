...
from SISR.reaction_mechanism_generator_hidden_variable import ReactionMechanismGenerator as rmg, reaction_system
...
plt.grid()
plt.savefig("Sequential_concentration_Hidden_Variable_B.png", dpi=300, bbox_inches='tight')
...
plt.legend(["A", "B", "C", "D"], fontsize=20)
plt.grid()
plt.savefig("Sequential_concentration_fit_Hidden_Variable_B.png", dpi=300, bbox_inches='tight')
