...
# Create a function that imports the file "GO_data.txt" and returns t_test and x_test
...
t_test, x_test = import_data("input_data/GO_data.txt")
...
plt.ylabel("Concentration (micro mol/L)", fontsize=20)
plt.xticks(fontsize=20)
plt.yticks(fontsize=20)
plt.legend(["alpha", "beta", "O2", "delta", "H2O2"], fontsize=20)
plt.grid()
plt.savefig("GO_concentration.png", dpi=300, bbox_inches='tight')


# rmg inputs
number_of_generations = 10
mechanisms_per_generation = 4000
min_rxns_per_mech = 3
max_rxns_per_mech = 3
...
plt.xlabel("Time (s)", fontsize=20)
plt.ylabel("Concentration (micromol/L)", fontsize=20)
plt.xticks(fontsize=20)
plt.yticks(fontsize=20)
plt.legend(["alpha", "beta", "O2", "delta", "H2O2"], fontsize=20)
plt.grid()
plt.savefig("GO_concentration_fit.png", dpi=300, bbox_inches='tight')
